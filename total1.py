...
S_data = np.array([df_o_total/ (1024*1024), df_s_total/ (1024*1024), df_c_total/ (1024*1024), df_m_total/ (1024*1024)])
print(S_data)
...
ax = plt.gca()
ax.tick_params(which='major', direction='in', length = 7)
plt.savefig('totalsinktestdata.png',bbox_inches='tight')
plt.savefig('totalsinktestdata.pdf',bbox_inches='tight')
plt.show()
