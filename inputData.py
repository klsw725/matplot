...
df800_s1 = open_file('SLP800_10_1.csv',"index","blackout","sink")
df1000_s1 = open_file('SLP1000_10_1.csv',"index","blackout","sink")
df1200_s1 = open_file('SLP1200_10_1.csv',"index","blackout","sink")

df800_s2 = open_file('SLP800_10_2.csv',"index","blackout","sink")
df1000_s2 = open_file('SLP1000_10_2.csv',"index","blackout","sink")
df1200_s2 = open_file('SLP1200_10_2.csv',"index","blackout","sink")

df800_s3 = open_file('SLP800_10_3.csv',"index","blackout","sink")
df1000_s3 = open_file('SLP1000_10_3.csv',"index","blackout","sink")
df1200_s3 = open_file('SLP1200_10_3.csv',"index","blackout","sink")

df800_s4 = open_file('SLP800_10_4.csv',"index","blackout","sink")
df1000_s4 = open_file('SLP1000_10_4.csv',"index","blackout","sink")
df1200_s4 = open_file('SLP1200_10_4.csv',"index","blackout","sink")

df800_s5 = open_file('SLP800_10_5.csv',"index","blackout","sink")
df1000_s5 = open_file('SLP1000_10_5.csv',"index","blackout","sink")
df1200_s5 = open_file('SLP1200_10_5.csv',"index","blackout","sink")
...
df800_c1 = open_file('CLP800_10_1.csv',"index","blackout","sink")
df1000_c1 = open_file('CLP1000_10_1.csv',"index","blackout","sink")
df1200_c1 = open_file('CLP1200_10_1.csv',"index","blackout","sink")

df800_c2 = open_file('CLP800_10_2.csv',"index","blackout","sink")
df1000_c2 = open_file('CLP1000_10_2.csv',"index","blackout","sink")
df1200_c2 = open_file('CLP1200_10_2.csv',"index","blackout","sink")

df800_c3 = open_file('CLP800_10_3.csv',"index","blackout","sink")
df1000_c3 = open_file('CLP1000_10_3.csv',"index","blackout","sink")
df1200_c3 = open_file('CLP1200_10_3.csv',"index","blackout","sink")

df800_c4 = open_file('CLP800_10_4.csv',"index","blackout","sink")
df1000_c4 = open_file('CLP1000_10_4.csv',"index","blackout","sink")
df1200_c4 = open_file('SLP1200_10_4.csv',"index","blackout","sink")

df800_c5 = open_file('CLP800_10_5.csv',"index","blackout","sink")
df1000_c5 = open_file('CLP1000_10_5.csv',"index","blackout","sink")
df1200_c5 = open_file('CLP1200_10_5.csv',"index","blackout","sink")
