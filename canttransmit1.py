...
osink = []
totalo = 0
for j in range(0,len(df_o[0]['canttransmit'])):
    totalo = totalo + df_o[0]['canttransmit'][j]
    if j % 12 == 11:
        totalo = totalo * 5 / 60
        osink.append(totalo)
        totalo = 0
...
msink = []
totalo = 0
for j in range(0,len(df_m[0]['canttransmit'])):
    totalo = totalo + df_m[0]['canttransmit'][j]
    if j % 12 == 11:
        totalo = totalo * 5 / 60
        msink.append(totalo)
        totalo = 0
...
ssink = []
totalo = 0
for j in range(0,len(df_s[0]['canttransmit'])):
    totalo = totalo + df_s[0]['canttransmit'][j]
    if j % 12 == 11:
        totalo = totalo * 5 / 60
        ssink.append(totalo)
        totalo = 0
...
csink = []
totalo = 0
for j in range(0,len(df_c[0]['canttransmit'])):
    totalo = totalo + df_c[0]['canttransmit'][j]
    if j % 12 == 11:
        totalo = totalo * 5 / 60
        csink.append(totalo)
        totalo = 0
