...
S_data = np.array([[df_o[0]/ (1024*1024), df_m[0] / (1024*1024)],
                  [df_o[1] / (1024*1024), df_m[1] / (1024*1024)],
                  [df_o[2] / (1024*1024), df_m[2] / (1024*1024)]])
...
df_S = pd.DataFrame(data=S_data,index=[format(800,","),format(1000,","),format(1200,",")], columns=('LBDD','Proposed scheme'))
